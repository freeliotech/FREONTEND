        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {branches.map((b, i) => (
            <motion.div
              ...
              className="bg-[#101727] border border-white/50 rounded-xl overflow-hidden hover:border-purple-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.25)] transition-all duration-300 cursor-pointer h-[330px] flex flex-col group"
              onClick={() => {
                setBranch(b);
                setStep(1);
              }}
            >
              ...
              <div className="h-[40%] p-4 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  {/* BUTTON */}
                  <button className="text-xs px-3 py-1 rounded-md bg-purple-600 hover:bg-purple-700 hover:shadow-[0_0_10px_rgba(168,85,247,0.6)] transition-all duration-300">
                    →
                  </button>
                </div>
              </div>
